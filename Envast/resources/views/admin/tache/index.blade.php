...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="" action="/Tache-store" method="POST">
                        ...
                        <table class="table">
                            ...
                            @foreach($Tache as $tache)
                                ...
                                <tr>
                                    ...
                                    <td style='text-align:center'>{{$tache->user->name}}</td>
                                    ...
                                    <td style='text-align:center'><a href="/Tache-edit/{{$tache->id}}" class="btn btn-success" href="#">Modifier</a></td>
                                    <td style='text-align:center'>
                                      <form  action="/Tache-delete/{{$tache->id}}" method="post">
                                        {{csrf_field()}}
                                        {{method_field('DELETE')}}
